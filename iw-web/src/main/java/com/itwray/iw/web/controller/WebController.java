 ...
 * @since 2024/9/11
 */
public abstract class WebController<S extends WebService, A extends AddDto, U extends UpdateDto, L extends DetailVo> {
    ...
    public L detail(@RequestParam("id") Serializable id) {
        return (L) getWebService().detail(id);
    }
